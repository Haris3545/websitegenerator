 ...
 * reads as YouTube-specific at a glance. Colours are hardcoded (white body,
 * red triangle, thin black outline) rather than currentColor, since this
 * sits on menu items whose text colour flips between light/dark mode —
 * inheriting that would make the body itself flip too, when it's meant to
 * read the same regardless of surrounding theme. */
