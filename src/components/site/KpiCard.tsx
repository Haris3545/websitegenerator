...
export function KpiCard({
  ...
  return (
    <div
      className="overflow-hidden p-4 shadow-lg shadow-black/30 backdrop-blur-md transition-[transform,filter,box-shadow] duration-150 ease-out [@media(hover:hover)_and_(pointer:fine)]:hover:-translate-y-0.5 hover:brightness-110 hover:shadow-[0_0_28px_var(--accent)]"
      style={{
