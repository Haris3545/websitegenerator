...
import { TacticsBoard } from "@/components/site/tactics/TacticsBoard";
...
export default async function TacticsPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const tab = TABS.find((t) => t.key === "tactics")!;
  const titleKey = "board.tactics.title";
  const contentKey = "board.tactics.subtitle";
